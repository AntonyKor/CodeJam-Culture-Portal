    ...
    return (
      <div className={styles.wrapper}>
        ...
        <div className={styles.devTeam}>
          ...
          <img src={require('../../images/team/AntonyKor.png')} width="100%" />
          ...
          <div className={styles.devCard}>
          <img src={require('../../images/team/gleb7raul.png')} width="100%" />
            <ul className={styles.devName}>
              <li>gleb7raul</li>
          ...
          <div className={styles.devCard}>
          <img src={require('../../images/team/vvikota.jpg')} width="100%" />
            <ul className={styles.devName}>
              <li>vvikota</li>
              <li>Viktar Rymsha</li>
            </ul>
          ...
          <div className={styles.devCard}>
          <img src={require('../../images/team/NoviceBlunderer.png')} width="100%" />
            <ul className={styles.devName}>
